import{d as I,L as j,f as o,T as w,c as f,S as X,_ as S,r as B,D as K,a3 as U,F as _,Q as b,ai as Z,a5 as G,U as P,M as Q}from"./index-DDOnw_dn.js";import{o as q}from"./dep-b315df3e-C2hVJkwZ.js";import{c as W}from"./useResizeObserver-qPY2ykBa.js";import{u as tt}from"./useVirtualScrollNew-CeNdADLm.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */var gt=P(ct),yt=P(A);P(vt);const St=async(r,t="复制成功")=>{try{await navigator.clipboard.writeText(r)}catch{const e=document.createElement("textarea");e.value=r,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e)}Q.success(t)};export{gt as L,yt as a,St as c};

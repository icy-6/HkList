import{au as C,b9 as M,bj as W,bk as p,bl as G,bm as K,bn as B,bo as U,K as w,aI as D,bp as q,bq as H,bc as F,br as X,bs as Y,bb as j,am as z,bt as J}from"./index-CXsQrBlN.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */var E=p,In=U,xn=w,A=E?E.isConcatSpreadable:void 0;function Sn(n){return xn(n)||In(n)||!!(A&&n&&n[A])}var En=Sn,An=B,Cn=En;function L(n,e,t,s,i){var f=-1,u=n.length;for(t||(t=Cn),i||(i=[]);++f<u;){var a=n[f];e>0&&t(a)?e>1?L(a,e-1,t,s,i):An(i,a):s||(i[i.length]=a)}return i}var Fn=L,Ln=Fn;function Nn(n){var e=n==null?0:n.length;return e?Ln(n,1):[]}var Pn=Nn,Rn=Pn,kn=G,Mn=K;function Wn(n){return Mn(kn(n,void 0,Rn),n+"")}var pn=Wn;/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 */var Gn=j,Kn=z;function Bn(n,e){return e.length<2?n:Gn(n,Kn(e,0,-1))}var Un=Bn,wn=F,Dn=hn,qn=Un,Hn=X;function Xn(n,e){return e=wn(e,n),n=qn(n,e),n==null||delete n[Hn(Dn(e))]}var Yn=Xn,jn=J;function zn(n){return jn(n)?void 0:n}var Jn=zn,Qn=D,Vn=Y,Zn=Yn,ne=F,ee=q,te=Jn,re=pn,ae=H,ie=1,se=2,fe=4,ue=re(function(n,e){var t={};if(n==null)return t;var s=!1;e=Qn(e,function(f){return f=ne(f,n),s||(s=f.length>1),f}),ee(n,ae(n),t),s&&(t=Vn(t,ie|se|fe,te));for(var i=e.length;i--;)Zn(t,e[i]);return t}),me=ue;export{Fn as _,pn as a,oe as d,hn as l,me as o,cn as t};

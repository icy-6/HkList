 ...
 * (c) 2024 tdesign
 * @license MIT
 */var E=W,xn=K,In=U,A=E?E.isConcatSpreadable:void 0;function Sn(n){return In(n)||xn(n)||!!(A&&n&&n[A])}var En=Sn,An=B,Ln=En;function F(n,e,t,s,i){var f=-1,u=n.length;for(t||(t=Ln),i||(i=[]);++f<u;){var a=n[f];e>0&&t(a)?e>1?F(a,e-1,t,s,i):An(i,a):s||(i[i.length]=a)}return i}var Cn=F,Fn=Cn;function Nn(n){var e=n==null?0:n.length;return e?Fn(n,1):[]}var Pn=Nn,Rn=Pn,Mn=G,kn=w;function pn(n){return kn(Mn(n,void 0,Rn),n+"")}var Wn=pn;/**
 * tdesign v1.10.6
 * (c) 2024 tdesign
 * @license MIT
 */var Gn=z,wn=J;function Bn(n,e){return e.length<2?n:Gn(n,wn(e,0,-1))}var Kn=Bn,Un=C,Dn=hn,qn=Kn,Hn=X;function Xn(n,e){return e=Un(e,n),n=qn(n,e),n==null||delete n[Hn(Dn(e))]}var Yn=Xn,zn=Q;function Jn(n){return zn(n)?void 0:n}var Qn=Jn,Vn=D,Zn=Y,jn=Yn,ne=C,ee=q,te=Qn,re=Wn,ae=H,ie=1,se=2,fe=4,ue=re(function(n,e){var t={};if(n==null)return t;var s=!1;e=Vn(e,function(f){return f=ne(f,n),s||(s=f.length>1),f}),ee(n,ae(n),t),s&&(t=Zn(t,ie|se|fe,te));for(var i=e.length;i--;)jn(t,e[i]);return t}),me=ue;export{Cn as _,Wn as a,le as d,hn as l,me as o,cn as t};

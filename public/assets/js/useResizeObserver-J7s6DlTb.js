import{bB as C,C as P,r as R,K as T,x as S,a6 as z,be as I,B as k,w as B,N as M}from"./index-C5Ad9MSy.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 */var j=C.expand,D=C.ripple,V=C.fade;function W(){var r=P("animation"),t=r.globalConfig,n=function(u){var c,l,i=t.value;return i&&!((c=i.exclude)!==null&&c!==void 0&&c.includes(u))&&((l=i.include)===null||l===void 0?void 0:l.includes(u))};return{keepExpand:n(j),keepRipple:n(D),keepFade:n(V)}}/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */function G(r,t){if(!(typeof window>"u")){var n=window&&window.ResizeObserver;if(n){var e=null,u=function(){!e||!r.value||(e.unobserve(r.value),e.disconnect(),e=null)},c=function(i){e=new ResizeObserver(t),e.observe(i)};r&&B(r,function(l){u(),l&&c(l)},{immediate:!0,flush:"post"}),M(function(){u()})}}}export{F as a,G as b,q as l,H as u};

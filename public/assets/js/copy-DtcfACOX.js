import{d as I,I as j,e as o,Q as w,c as f,P as X,_ as S,r as B,A as K,a1 as Z,F as _,N as b,aj as G,a3 as Q,R as P,M as U}from"./index-Ulp6C0v5.js";import{o as q}from"./dep-b315df3e-SzkKAuga.js";import{g as W}from"./index-BYt7tsOP.js";import{u as tt}from"./useVirtualScrollNew-RQKjpSru.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */var gt=P(ct),yt=P(x);P(vt);const St=async(r,t="复制成功")=>{try{await navigator.clipboard.writeText(r)}catch{const e=document.createElement("textarea");e.value=r,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e)}U.success(t)};export{gt as L,yt as a,St as c};

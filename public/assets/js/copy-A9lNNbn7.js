import{d as I,Q as j,h as o,Y as w,c as f,X as R,U as S,b as B,I as Z,ab as K,F as _,aA as U,V as b,at as G,ae as Q,Z as P,M as q}from"./index-CbTStCTl.js";import{b as W}from"./useResizeObserver-CP_6mhRt.js";import{u as tt}from"./useVirtualScrollNew-x1EN4-3H.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */var x=I({name:"TListItem",props:et,setup:function(){var t=j("list-item"),e=w();return function(){var n=e("content"),i=e("default"),a=e("action");return o("li",{class:t.value},[o("div",{class:"".concat(t.value,"-main")},[i||n,a&&o("li",{class:"".concat(t.value,"__action")},[a])])])}}});/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */function E(r,t){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);t&&(n=n.filter(function(i){return Object.getOwnPropertyDescriptor(r,i).enumerable})),e.push.apply(e,n)}return e}function st(r){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?E(Object(e),!0).forEach(function(n){S(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):E(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}var ct=I({name:"TList",props:st({},rt),setup:function(t){var e=B(),n=Z("list"),i=n.globalConfig,a=j("list"),u=K(),s=u.SIZE,l=w(),c=lt(),C=c.listItems,p=it(t.scroll,e,C),m=p.virtualConfig,O=p.cursorStyle,h=p.listStyle,M=p.isVirtualScroll,F=p.onInnerVirtualScroll,D=f(function(){return["".concat(a.value),s.value[t.size],S(S(S({},"".concat(a.value,"--split"),t.split),"".concat(a.value,"--stripe"),t.stripe),"".concat(a.value,"--vertical-action"),t.layout==="vertical")]}),H=function(){var d=l("header"),v=l("footer"),g=m.isVirtualScroll.value;return o(_,null,[d?o("div",{class:"".concat(a.value,"__header")},[d]):null,g?o(_,null,[o("div",{style:O.value},null),o("ul",{class:"".concat(a.value,"__inner"),style:h.value},[m.visibleData.value.map(function(y){return o(_,null,[o(x,U(y,"slots"),y.slots)])})])]):o("ul",{class:"".concat(a.value,"__inner")},[l("default")]),v?o("div",{class:"".concat(a.value,"__footer")},[v]):null])},$=function(d){var v,g=d.target,y=g.scrollTop,X=g.scrollHeight,J=g.clientHeight;M.value&&F(d),(v=t.onScroll)===null||v===void 0||v.call(t,{e:d,scrollTop:y,scrollBottom:X-J-y})},k=f(function(){return b(t.asyncLoading)&&["loading","load-more"].includes(t.asyncLoading)?"".concat(a.value,"__load ").concat(a.value,"__load--").concat(t.asyncLoading):"".concat(a.value,"__load")}),z=function(){if(t.asyncLoading&&b(t.asyncLoading)){if(t.asyncLoading===nt)return o("div",null,[o(G,null,null),o("span",null,[i.value.loadingText])]);if(t.asyncLoading===T)return o("span",null,[i.value.loadingMoreText])}return l("asyncLoading")},Y=function(d){var v;b(t.asyncLoading)&&t.asyncLoading!==T||(v=t.onLoadMore)===null||v===void 0||v.call(t,{e:d})};return{COMPONENT_NAME:a,listClass:D,loadingClass:k,renderLoading:z,renderContent:H,handleScroll:$,handleLoadMore:Y,listRef:e,isVirtualScroll:M}},render:function(){var t=this.renderContent();return t=[t,o("div",{class:this.loadingClass,onClick:this.handleLoadMore},[this.renderLoading()])],o("div",{class:this.listClass,onScroll:this.handleScroll,ref:"listRef",style:this.isVirtualScroll?"position:relative":void 0},[t])}});/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 ...
 * (c) 2024 tdesign
 * @license MIT
 */var mt=P(ct),gt=P(x);P(vt);const yt=async(r,t="复制成功")=>{try{await navigator.clipboard.writeText(r)}catch{const e=document.createElement("textarea");e.value=r,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e)}q.success(t)};export{mt as L,gt as a,yt as c};

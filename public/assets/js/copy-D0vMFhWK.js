import{d as I,J as j,e as o,R as w,c as f,Q as B,_ as S,r as X,B as K,a2 as Z,F as _,O as b,ak as G,a4 as Q,S as P,M as U}from"./index-DxnYDW4g.js";import{o as q}from"./dep-b315df3e-lsOADVIN.js";import{g as W}from"./index-C1P_1hrf.js";import{u as tt}from"./useVirtualScrollNew-Dm_6GERz.js";/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var a,u=!0,s=!1;return{s:function(){e=e.call(r)},n:function(){var c=e.next();return u=c.done,c},e:function(c){s=!0,a=c},f:function(){try{u||e.return==null||e.return()}finally{if(s)throw a}}}}function ot(r,t){if(r){if(typeof r=="string")return E(r,t);var e={}.toString.call(r).slice(8,-1);return e==="Object"&&r.constructor&&(e=r.constructor.name),e==="Map"||e==="Set"?Array.from(r):e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?E(r,t):void 0}}function E(r,t){(t==null||t>r.length)&&(t=r.length);for(var e=0,n=Array(t);e<t;e++)n[e]=r[e];return n}var lt=function(){var t=W(),e=f(function(){var n=[],i=t("ListItem");if(B(i)){var a=at(i),u;try{for(a.s();!(u=a.n()).done;){var s=u.value;n.push(V(V({},s.props),{},{slots:s.children}))}}catch(l){a.e(l)}finally{a.f()}}return n});return{listItems:e}};/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 */var it=function(t,e,n){var i=f(function(){return{data:n.value,scroll:t}}),a=tt(e,i),u=f(function(){return a.isVirtualScroll.value}),s=-1,l=function(m){var C=m.target||m.srcElement,h=C.scrollTop;s!==h?a.isVirtualScroll.value&&a.handleScroll():s=-1,s=h},c=f(function(){return{position:"absolute",width:"1px",height:"1px",transition:"transform 0.2s",transform:"translate(0, ".concat(a.scrollHeight.value,"px)"),"-ms-transform":"translate(0, ".concat(a.scrollHeight.value,"px)"),"-moz-transform":"translate(0, ".concat(a.scrollHeight.value,"px)"),"-webkit-transform":"translate(0, ".concat(a.scrollHeight.value,"px)")}}),O=f(function(){return{transform:"translate(0, ".concat(a.translateY.value,"px)"),"-ms-transform":"translate(0, ".concat(a.translateY.value,"px)"),"-moz-transform":"translate(0, ".concat(a.translateY.value,"px)"),"-webkit-transform":"translate(0, ".concat(a.translateY.value,"px)")}});return{virtualConfig:a,cursorStyle:c,listStyle:O,isVirtualScroll:u,onInnerVirtualScroll:l}};/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
 */function x(r,t){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);t&&(n=n.filter(function(i){return Object.getOwnPropertyDescriptor(r,i).enumerable})),e.push.apply(e,n)}return e}function st(r){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?x(Object(e),!0).forEach(function(n){S(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):x(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}var ct=I({name:"TList",props:st({},rt),setup:function(t){var e=X(),n=K("list"),i=n.globalConfig,a=j("list"),u=Z(),s=u.SIZE,l=w(),c=lt(),O=c.listItems,p=it(t.scroll,e,O),m=p.virtualConfig,C=p.cursorStyle,h=p.listStyle,M=p.isVirtualScroll,F=p.onInnerVirtualScroll,D=f(function(){return["".concat(a.value),s.value[t.size],S(S(S({},"".concat(a.value,"--split"),t.split),"".concat(a.value,"--stripe"),t.stripe),"".concat(a.value,"--vertical-action"),t.layout==="vertical")]}),H=function(){var d=l("header"),v=l("footer"),g=m.isVirtualScroll.value;return o(_,null,[d?o("div",{class:"".concat(a.value,"__header")},[d]):null,g?o(_,null,[o("div",{style:C.value},null),o("ul",{class:"".concat(a.value,"__inner"),style:h.value},[m.visibleData.value.map(function(y){return o(_,null,[o(A,q(y,"slots"),y.slots)])})])]):o("ul",{class:"".concat(a.value,"__inner")},[l("default")]),v?o("div",{class:"".concat(a.value,"__footer")},[v]):null])},k=function(d){var v,g=d.target,y=g.scrollTop,R=g.scrollHeight,Y=g.clientHeight;M.value&&F(d),(v=t.onScroll)===null||v===void 0||v.call(t,{e:d,scrollTop:y,scrollBottom:R-Y-y})},$=f(function(){return b(t.asyncLoading)&&["loading","load-more"].includes(t.asyncLoading)?"".concat(a.value,"__load ").concat(a.value,"__load--").concat(t.asyncLoading):"".concat(a.value,"__load")}),z=function(){if(t.asyncLoading&&b(t.asyncLoading)){if(t.asyncLoading===nt)return o("div",null,[o(G,null,null),o("span",null,[i.value.loadingText])]);if(t.asyncLoading===T)return o("span",null,[i.value.loadingMoreText])}return l("asyncLoading")},J=function(d){var v;b(t.asyncLoading)&&t.asyncLoading!==T||(v=t.onLoadMore)===null||v===void 0||v.call(t,{e:d})};return{COMPONENT_NAME:a,listClass:D,loadingClass:$,renderLoading:z,renderContent:H,handleScroll:k,handleLoadMore:J,listRef:e,isVirtualScroll:M}},render:function(){var t=this.renderContent();return t=[t,o("div",{class:this.loadingClass,onClick:this.handleLoadMore},[this.renderLoading()])],o("div",{class:this.listClass,onScroll:this.handleScroll,ref:"listRef",style:this.isVirtualScroll?"position:relative":void 0},[t])}});/**
 * tdesign v1.10.4
 * (c) 2024 tdesign
 * @license MIT
